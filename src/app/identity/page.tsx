  ...
  return (
    <main className="h-dvh w-full flex flex-col relative overflow-hidden bg-background">
      <div className="p-4 sm:p-8 pt-12 sm:pt-32 shrink-0">
        ...
        <h2 className="font-display text-[10vw] sm:text-[7vw] uppercase leading-[0.75] tracking-[-0.05em] mb-4">Skills</h2>
      </div>
         ...
         <div className="w-full sm:w-1/2 p-4 sm:p-8 flex flex-col justify-between h-[50dvh] sm:h-full overflow-y-auto shrink-0">
           <div className="space-y-4 sm:space-y-6 flex-1 flex flex-col justify-center">
             <p className="text-xl sm:text-2xl lg:text-3xl leading-[1.1] sm:leading-relaxed px-0.5">
               Team coordination, time management and adaptable, creativity, social media marketing engagement , content creation, email marketing, trying creative ideas, building auditions interaction, targeting audience, inclusive thinking ideas, social media page prompting confidence and self love , risk management, problem solving, decision making, timeline.. 
             </p>
