...
export default function Credentials() {
  return (
    <main className="h-dvh w-full flex flex-col sm:flex-row-reverse relative overflow-hidden bg-background">
      <div className="w-full sm:w-1/2 p-4 sm:p-8 pt-12 sm:pt-32 flex flex-col justify-between h-[55dvh] sm:h-full overflow-hidden shrink-0">
         <div className="flex-1 flex flex-col justify-center max-w-xl mx-auto sm:mx-0 w-full px-0.5">
            ...
            <div className="flex flex-col gap-4 sm:gap-12">
              ...
              <div className="border-b border-[#111111]/30 pb-3 sm:pb-8">
                <h2 className="font-display text-4xl sm:text-5xl uppercase leading-[0.85] tracking-[-0.05em] mb-1 sm:mb-4 hyphens-auto break-words">Advanced <br/> Level</h2>
                <div className="text-xs md:text-sm uppercase tracking-widest flex justify-between gap-4 opacity-80">
                  <span>Commerce</span>
              ...
              <div className="border-b border-[#111111]/30 pb-3 sm:pb-8">
                <h2 className="font-display text-4xl sm:text-5xl uppercase leading-[0.85] tracking-[-0.05em] mb-1 sm:mb-4 hyphens-auto break-words lg:text-nowrap">Google Digital <br/> Marketing</h2>
                <div className="text-xs md:text-sm uppercase tracking-widest flex justify-between gap-4 opacity-80">
                  <span>Coursera</span>
         ...
         <div className="flex justify-between mt-4 sm:mt-0 pb-4 sm:pb-0">
            <Link href="/" className="text-xs md:text-sm uppercase tracking-widest hover:line-through inline-flex items-center gap-4 w-max opacity-50 group">
              <span className="font-display text-lg leading-none transform group-hover:-translate-x-1 transition-transform">←</span>
              <span>Prev</span>
            </Link>
            <Link href="/identity" className="text-xs md:text-sm uppercase tracking-widest hover:line-through inline-flex items-center gap-4 w-max group">
